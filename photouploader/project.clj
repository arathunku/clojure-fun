...
(defproject photouploader "0.1.0-SNAPSHOT"
  ...
  :joplin {:migrators {:jdbc-mig "src/migrators/jdbc"}
           :databases {:sql-dev      {:type :jdbc, :url ~(str "jdbc:postgresql://127.0.0.1:5432/clojure-fun-photoupload?user=" POSTGRES-USER "&password=" POSTGRES-PASSWORD)}}
           :environments {:dev [{:db :sql-dev, :migrator :jdbc-mig}]}}
